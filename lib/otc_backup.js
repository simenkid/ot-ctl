...
function removeInvalidLastLine(lines) {
    ...
    let isInvalid = (lastLine === '' || lastLine.startsWith('Done') || lastLine === '> ' || lastLine.startsWith('> Done'));
    ...
    while (isInvalid) {
        ...
        isInvalid = (lastLine === '' || lastLine.startsWith('Done') || lastLine === '> ' || lastLine.startsWith('> Done'));
    }
    return lines;
}
